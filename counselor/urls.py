...
from .views import counsellor_list_page, login_user, logout_user, student_profile, counsellor_profile, user_type_page, approval_waiting, student_list_page, my_counsil_page, my_profile_page, my_counsil_profile, student_counselling_page, college_branch_page
